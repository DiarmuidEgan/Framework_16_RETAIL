...
class TeamTable extends TableEntity {
    ...
    public function CreateTeam($teamName){
        ...
        $this->SQL="INSERT INTO teams (team_name) VALUES ('$teamName')";   
        //execute the  query
        try {
    ...
    public function UpdateTeam($UpdateID, $UpdateValue){
        
        
    $this->SQL="UPDATE `k00283736_framework_16`.`teams`
                SET
               `team_name` = '".$UpdateValue."'
                WHERE `team_id` = '".$UpdateID."';
                ";        
