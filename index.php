...
include_once 'classlib/entities/TeamTable.php';
include_once 'classlib/entities/MatchTable.php';
...
include_once 'models/panelContent/ManagerManageProducts.php';
include_once 'models/panelContent/CRUDTeam.php';
include_once 'models/panelContent/CRUDMatches.php';
